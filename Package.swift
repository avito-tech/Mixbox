...
let package = Package(
    ...
    products: [
        ...
        .library(name: "MixboxInAppServices_objc", type: .dynamic, targets: ["MixboxInAppServices_objc"]),
        .library(name: "MixboxInAppServices", type: .dynamic, targets: ["MixboxInAppServices"]),
        .library(name: "MixboxIoKit_objc", type: .dynamic, targets: ["MixboxIoKit_objc"]),
        .library(name: "MixboxIoKit", type: .dynamic, targets: ["MixboxIoKit"]),
