...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "MixboxBlack",
                ...
                cxxSettings: cxxSettings(),
                swiftSettings: swiftSettings(),
                linkerSettings: [.linkedFramework("XCTest"),.linkedLibrary("swiftXCTest"), .linkedFramework("XCTAutomationSupport"), .unsafeFlags(["-F/Applications/XCode.app/Contents/Developer/Library/PrivateFrameworks"])]),
