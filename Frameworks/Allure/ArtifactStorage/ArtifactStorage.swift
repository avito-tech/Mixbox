// Rewrite. The interface is not generic. It only seems generic. It is strange. It suits for storing
// files for Allure, but I don't know if it can be reused for something else
//
// Old docs:
//
// What it is:
