enum TccDbServiceId: String {
    ...
    // I think it was removed from some iOS:
    case addressBook = "kTCCServiceAddressBook"
    
    // I don't think, I see, I copy, I paste:
    case bluetoothPeripheral = "kTCCServiceBluetoothPeripheral"
    case calls = "kTCCServiceCalls"
    case facebook = "kTCCServiceFacebook"
    case keyboardNetwork = "kTCCServiceKeyboardNetwork"
