...
+ (instancetype)symbolicationRecordFromRemoteServiceForAddress:(unsigned long long)arg1;
+ (instancetype)symbolicationRecordForTask:(unsigned int)arg1 address:(unsigned long long)arg2;
+ (instancetype)symbolicationRecordForAddress:(unsigned long long)arg1;
