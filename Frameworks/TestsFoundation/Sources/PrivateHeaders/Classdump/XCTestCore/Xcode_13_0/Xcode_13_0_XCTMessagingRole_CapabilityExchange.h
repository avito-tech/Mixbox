...
@class XCAXAuditConfiguration, XCAXAuditResultCollection, XCAccessibilityElement, XCElementSnapshot, XCTCapabilities, XCTImage, XCTScreenshotRequest, XCTSerializedTransportWrapper, XCTSpindumpRequestSpecification, XCUIElementSnapshotRequestResult;
