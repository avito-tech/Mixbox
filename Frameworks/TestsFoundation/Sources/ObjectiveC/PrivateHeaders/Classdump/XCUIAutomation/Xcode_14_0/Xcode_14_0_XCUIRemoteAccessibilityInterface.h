...
@class XCAXAuditConfiguration, XCAXAuditResultCollection, XCAccessibilityElement, XCElementSnapshot, XCTCapabilities, XCUIAccessibilityAction, XCUIElementSnapshotRequestResult;
