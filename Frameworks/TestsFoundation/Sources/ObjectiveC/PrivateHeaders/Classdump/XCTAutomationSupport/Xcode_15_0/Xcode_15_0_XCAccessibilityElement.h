...
@interface XCAccessibilityElement : NSObject <NSCopying, NSSecureCoding>
{
    ...
    /* unknown type (struct __AXUIElement) was removed in dump.py */ void *_AXUIElement;
...
+ (id)mockInvalidElementWithProcessIdentifier:(int)arg1 originPlatform:(unsigned long long)arg2 payload:(id)arg3;
+ (id)mockElementWithProcessIdentifier:(int)arg1 originPlatform:(unsigned long long)arg2 payload:(id)arg3;
+ (id)mockInvalidElementWithProcessIdentifier:(int)arg1 originPlatform:(unsigned long long)arg2;
...
+ (id)mockInvalidElementWithProcessIdentifier:(int)arg1;
...
@property(readonly) /* unknown type (struct __AXUIElement) was removed in dump.py */ void *AXUIElement; // @synthesize AXUIElement=_AXUIElement;
