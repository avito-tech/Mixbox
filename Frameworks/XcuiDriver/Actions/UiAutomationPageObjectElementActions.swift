...
final class UiAutomationPageObjectElementActions: AlmightyElementActions {
    ...
    func with(settings: ElementSettings) -> AlmightyElementActions {
        return UiAutomationPageObjectElementActions(
        ...
        actionSettings: ActionSettings)
    {
        return perform(actionSettings: actionSettings) {
            ...
            let pasteButton = UiAutomationPageObjectElementActions.menuItem(
        ...
        actionSettings: ActionSettings)
    {
        return perform(actionSettings: actionSettings) {
            ...
            let selectAllButton = UiAutomationPageObjectElementActions.menuItem(
            ...
            let cutButton = UiAutomationPageObjectElementActions.menuItem(
