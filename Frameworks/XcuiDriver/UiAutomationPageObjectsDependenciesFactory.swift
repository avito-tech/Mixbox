...
public final class UiAutomationPageObjectsDependenciesFactory: PageObjectsDependenciesFactory {
    ...
    public func pageObjectElementFactory() -> PageObjectElementFactory {
        return UiAutomationPageObjectElementFactory(
            uiAutomationHelperFactory: UiAutomationHelperFactoryImpl(
                interactionExecutionLogger: interactionExecutionLogger,
                testFailureRecorder: testFailureRecorder,
